...
from model_2d import create_model, PointRend
...
parser.add_argument('--moe', type=eval, default=True, choices=[True, False])
...
if __name__ == '__main__':
    ...
    # net = create_model(num_classes=FLAGS.num_classes)
    # save_mode_path = os.path.join(
    #     snapshot_path, 'iter_{}.pth'.format(FLAGS.epoch))
    
    # model = create_model(FLAGS.num_classes).cuda()
    # net = model
    # save_mode_path = os.path.join(
    #     snapshot_path, 'iter_{}.pth'.format(FLAGS.epoch))
...
########### origin
# [[ 0.8699517   0.77174611 11.15460638  3.04433071]
#  [ 0.60432447  0.48836006 28.93586258  6.91816324]
#  [ 0.79622392  0.70163925 50.23243813 14.75849226]
#  [ 0.74747762  0.64555977 84.37058352 22.59585006]
#  [ 0.92425117  0.86162536 45.33040335 11.33997312]
#  [ 0.58193884  0.43375669 14.4453832   2.91584818]
#  [ 0.85973539  0.76724872 41.51298287 16.54929819]
#  [ 0.70891174  0.58263676 22.98939961  7.08129307]]
# [ 0.76160186  0.65657159 37.37145745 10.6504061 ]

############## ptrend
# [[ 0.88738835  0.800014   11.96026865  2.25094534]                                                                                   
#  [ 0.5998524   0.50033218 33.93859228  8.66750053]                                                                                   
#  [ 0.83351922  0.73265011 59.12839926 18.83216983]                                                                                   
#  [ 0.75373004  0.6623988  83.53721449 20.0268706 ]                                                                                   
#  [ 0.9298791   0.87249324 29.09509443  9.19461685]                                                                                   
#  [ 0.59618338  0.45584458 16.5599338   2.09505889]                                                                                   
#  [ 0.86309212  0.76676116 35.45819281 14.15083202]                                                                                   
#  [ 0.74216319  0.61850746 17.32162206  4.32740109]]                                                                                  
# [ 0.77572597  0.67612519 35.87491472  9.94317439]