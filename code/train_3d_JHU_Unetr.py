...
# from model_ISD_modified import*
# from model_ISD_modified_old_abla import *
# from model_3d_unet import Patcher, Patcher_UseOne, create_model_3d
from model_3d_UneTr import create_model_3d
# from dataloaders.dataset_3d import *
from dataloaders.JHU import *
...
parser.add_argument('--exp', type=str,
                    default='LA/patcher', help='experiment_name')
parser.add_argument('--resume', type=str,
                    default='/home/chenyu/Documents/PointRendMedical/model/LA/fully_supervised_100_labeled/vnet/iter_30000.pth', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    db_train = JHU(base_dir=args.root_path,
                       split='train',
    ...
    # model = Patcher_UseOne(args=args).cuda()
    model = create_model_3d(num_classes).cuda()
    # model.model.load_state_dict(torch.load(args.resume))
    
    model.train()

    optimizer = optim.SGD(model.parameters(), lr=base_lr, weight_decay=1e-4, momentum=0.9, nesterov=True)
