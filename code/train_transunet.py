...
from model_2d import PointRend_Transunet
...
parser.add_argument('--resume', type=str,
                    default='/home/weicheng/selfLearning/SSL4MIS/model/ACDC/Fully_Supervised_140_labeled/unet/iter_30000.pth', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    model = PointRend_Transunet(args=args).cuda()
