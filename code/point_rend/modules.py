...
def sample_nonzero_locations(t, target_size): # target_size = [b_s, 11, 11, 2]
...
class ContrastiveCorrelationLoss(nn.Module):
    ...
    def helper(self, f1, f2, c1, c2, shift):
        with torch.no_grad():
            ...
            fd = tensor_correlation(norm(f1), norm(f2)) # "nchw,ncij->nhwij"
        ...
        cd = tensor_correlation(norm(c1), norm(c2)) # "nchw,ncij->nhwij"
    ...
    def forward(self,
        ...
        # codes: class segmentation map
        # feats: feature map

        coord_shape = [orig_feats.shape[0], self.cfg.feature_samples, self.cfg.feature_samples, 2] # b_s, 11, 11, 2
        ...
        # pos_inter_shift: 0.02 pos_intra_shift: 0.08
        ...
        for i in range(self.cfg.neg_samples):
            ...
            neg_inter_loss, neg_inter_cd = self.helper(
                feats, feats_neg, code, code_neg, self.cfg.neg_inter_shift) # 0.46
